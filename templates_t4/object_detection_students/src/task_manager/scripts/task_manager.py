...
class FindTargat(smach.State):
    def __init__(self):
        ...
        self.target_object = 7 # target is traffic light
        self.centroids= []
        self.label = []
...
class Grasp(smach.State):
    def __init__(self):
        ...
        self.pub = rospy.Publisher('grasp_object', PoseStamped, queue_size=1)
        self.hold_object = False
        rospy.Subscriber('/grasp_done', Bool, self.hold_callback)
