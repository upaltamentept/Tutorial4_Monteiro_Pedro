...
private:
   ...
   * @return false failure
   */
  bool segmentCloud(CloudPtr& input, CloudPtr& plane_cloud, CloudPtr& objects_cloud,CloudPtr &shelf_cloud, CloudPtr &target_cloud);
...
private:
  ...
  ros::Publisher shelf_cloud_pub_;
  ...
  CloudPtr shelf_cloud_;    //!< points of objects
